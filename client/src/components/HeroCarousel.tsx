                ...
                <div className="absolute bottom-20 left-10 max-w-xl">
                  ...
                  {currentMovie.cast && (
                    <p className="text-xs md:text-md text-gray-200 mb-6 flex flex-row flex-wrap">
                      ...
                      {currentMovie.cast.slice(0, 3).map((actor, i, arr) => (
                        <span key={actor.id} className="px-1">
                          {actor.name}
                          {i < arr.length - 1 ? "," : ""}
                        </span>
                      ))}
                  ...
                  <div className="flex space-x-4">
                    <NavLink to={`/${currentMovie.id}`}>
                      <button className="px-8 py-2 bg-white text-black rounded hover:bg-white/90 flex items-center">
                        Play
                      </button>
                    </NavLink>

                    <NavLink to={`/${currentMovie.id}`}>
                      <button className="px-8 py-2 bg-gray-500/50 text-white rounded hover:bg-gray-500/40">
                        More Info
                      </button>
                    </NavLink>
                  </div>
