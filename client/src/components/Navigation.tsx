...
const Navigation = () => {
  ...
  return (
    <nav className="relative z-50">
      {/* Main navigation bar */}
      <div className="flex items-center justify-between px-4 md:px-12 py-4 bg-black/20 backdrop-blur-md">
        {/* Left side- Logo and links */}
        <div className="flex items-center">
          <div className="text-blue-700 text-2xl font-bold mr-8">MOVIEFLIX</div>
        ...
        <div className="flex items-center space-x-6 text-white">
          ...
          >
            <input
              ...
              className="w-full bg-white/10 border border-white/20 rounded-full px-4 py-2 pr-10 placeholder-gray-400 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300"
            />
            <button
              onClick={handleSearch}
              className="absolute right-2 p-1 hover:bg-white/10 rounded-full transition-colors duration-200"
            >
